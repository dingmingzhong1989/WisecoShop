...
public final class TcStatInterface {
    ...
    /**5分钟*/
    public static final int UPLOAD_TIME_THREAD = 5;
    /**10分钟*/
     ...
     * @param
     */
    public static void initialize(Context aContext, String userId,  String fileName) {

        context = aContext;

        TcStatSdk.getInstance(aContext).init(userId,  fileName);
     ...
     * 初始化Event
     */
    public static void initEvent(String useID, String eventAction, String tagid, String comment) {

        TcStatSdk.getInstance(context).initEvent(useID,eventAction,tagid,comment);
     ...
     * onEvent
     */
    public static void onEvent(String useID, String eventAction, String tagid, String comment) {
        initEvent(useID,eventAction,tagid,comment);
