...
public class TcStatSdk {
    ...
    protected void init(String appId,  String fileName) {

        staticsManager.onInit(appId,  fileName);
    ...
    protected void initEvent(String useID, String eventAction, String tagid, String comment) {

        staticsManager.onInitEvent(useID,eventAction,tagid,comment);
