...
public class TicketTimeOutFragment extends BaseFragment implements LoadingView.OnRetryListener, LoadingView.OnErroyClickListener {
    ...
    public View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_ticketout, null);
        ...
        if (msg != null) {
            switch (msg.what) {
                case MESSAGE_SET_ADAPTER:
                    ...
                    final TicketUserAdapter ticketAdapter = new TicketUserAdapter(allTicket,"out");
