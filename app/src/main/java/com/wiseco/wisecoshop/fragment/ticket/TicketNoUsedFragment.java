...
import com.wiseco.wisecoshop.adapter.ticket.TicketAdapter;
...
public class TicketNoUsedFragment extends BaseFragment implements LoadingView.OnRetryListener, LoadingView.OnErroyClickListener {
    ...
    public View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_ticketnoused, null);
       ...
       // mLoadingView.notifyDataChanged(LoadingView.State.ing);
        ...
        getActivity().registerReceiver(receiver, new IntentFilter("com.wiseco.wisecoshop.fragmentTicket"));
        return view;
    }
        ...
        if (msg != null) {
            switch (msg.what) {
                case MESSAGE_SET_ADAPTER:
                    ...
                    final TicketAdapter ticketAdapter = new TicketAdapter(allTicket);
