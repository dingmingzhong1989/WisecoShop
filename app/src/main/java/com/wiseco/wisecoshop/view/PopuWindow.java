...
/**
 * Created by wiseco on 2018/10/19.
 */

public abstract class PopuWindow {

    private final Context mContext;
    private final View contentView;
    private final PopupWindow mInstance;

    public PopuWindow(Context context, int layoutRes, int w, int h) {

        mContext = context;
        contentView = LayoutInflater.from(mContext).inflate(layoutRes, null, false);
