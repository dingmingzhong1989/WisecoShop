...
import com.wiseco.wisecoshop.activity.login.RegiestActivity;
...
public class RegiestDialog implements View.OnClickListener {
    private DialogView mDialogView;
    private TextView mCancle;
    private TextView mQuit;
    private Activity mSettinsActivity;

    public RegiestDialog(Activity activity) {
        mSettinsActivity = activity;
        init();
    }

    private void init() {
        View view = LayoutInflater.from(mSettinsActivity).inflate(R.layout.dialog_regiest, null);
    ...
    private void logout() {
        ...
        bundle.putInt("tag", 0);
        open(RegiestActivity.class,bundle);
